...
fn pub convert_velocities_to_collocated_grid_and_visualise(min_coords: [f32, 3], max_coords: [f32,3], data_grid_point_size: [f32, 3]) -> Vec<Vec<Vec<[f32;3]>>>{
    let mut step_size=[calc_step_size(max_coords[0]-min_coords[0], data_grid_point_size[0]), (max_coords[1]-min_coords[1], data_grid_point_size[1]), (max_coords[2]-min_coords[2], data_grid_point_size[2])];
...
fn get_velocity_at_pressure_point(pressure_point_coordinates)->f32{
